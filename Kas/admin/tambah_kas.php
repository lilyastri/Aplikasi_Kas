...
session_start();
	if($_POST["pasien"]){
			...
			mysql_query("insert into kas set kode='".$_POST["kode"]."', keterangan='".$_POST["nama"]."', tgl='".$_POST["tgl"]."', jumlah='".$_POST["usia"]."',jenis='Masuk'");
			echo("<script>
		...
		<div class="body">
			<form action="" method="post" class="form-horizontal"><font color="White">
						...
						<div class="form-actions no-margin-bottom" style="text-align:center;">
							<input type="submit" name="pasien" value="Simpan" class="btn btn-danger" /> <a href="?menu=kas_masuk" class="btn btn-danger">Back</a>
						</div>
