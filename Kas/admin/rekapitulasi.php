...
$max	 = ceil($jml/$row);
?>
<a href="?menu=tambah_kas" class="btn btn-danger btn-rect"><i class='icon icon-white icon-plus'></i> Entry</a><p>
	...
	<div class="panel-body">
		<div class="table-responsive">
			...
			<?php
				...
				$pasienQry = mysql_query($pasienSql, $server)  or die ("Query salah : ".mysql_error());
				$nomor  = 0;
